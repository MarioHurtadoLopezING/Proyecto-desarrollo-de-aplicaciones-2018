...
@NamedQueries({
    ...
    , @NamedQuery(name = "Registroactividad.findByIdAlumnoIdCurso", query = "SELECT r FROM Registroactividad "
            + "r WHERE r.idCurso.idCurso =:idCurso AND r.idAlumno.idAlumno =:idAlumno")})
public class Registroactividad implements Serializable {
    ...
    @JoinColumn(name = "idRegistro", referencedColumnName = "idActividad")
    @ManyToOne
    private Actividad idRegistro;
    ...
    public Actividad getIdRegistro() {
        return idRegistro;
    }

    public void setIdRegistro(Actividad idRegistro) {
